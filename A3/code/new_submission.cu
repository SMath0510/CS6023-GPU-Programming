...
__global__
void generate_image(int **gMesh, int *gGlobalCoordinatesX, int *gGlobalCoordinatesY, int *gFinalPng, int *gFrameSizeX, int *gFrameSizeY, int *gOpacity, int N, int M, int V){
